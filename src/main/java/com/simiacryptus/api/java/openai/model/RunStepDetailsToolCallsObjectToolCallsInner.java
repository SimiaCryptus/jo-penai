...
public class RunStepDetailsToolCallsObjectToolCallsInner {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `retrieval` to the URL query string
    if (getRetrieval() != null) {
      try {
        joiner.add(String.format("%sretrieval%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getRetrieval()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
