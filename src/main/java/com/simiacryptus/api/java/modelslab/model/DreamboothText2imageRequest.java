...
/**
 * DreamboothText2imageRequest
 */
@JsonPropertyOrder({
  DreamboothText2imageRequest.JSON_PROPERTY_GUIDANCE_SCALE,
  DreamboothText2imageRequest.JSON_PROPERTY_HEIGHT,
  DreamboothText2imageRequest.JSON_PROPERTY_KEY,
  DreamboothText2imageRequest.JSON_PROPERTY_MODEL_ID,
  DreamboothText2imageRequest.JSON_PROPERTY_NEGATIVE_PROMPT,
  DreamboothText2imageRequest.JSON_PROPERTY_NUM_INFERENCE_STEPS,
  DreamboothText2imageRequest.JSON_PROPERTY_PROMPT,
  DreamboothText2imageRequest.JSON_PROPERTY_SAMPLES,
  DreamboothText2imageRequest.JSON_PROPERTY_SEED,
  DreamboothText2imageRequest.JSON_PROPERTY_TRACK_ID,
  DreamboothText2imageRequest.JSON_PROPERTY_WEBHOOK,
  DreamboothText2imageRequest.JSON_PROPERTY_WIDTH
})
@JsonTypeName("dreamboothText2image_request")
...
public class DreamboothText2imageRequest {
  ...
  public DreamboothText2imageRequest() {
  }

  public DreamboothText2imageRequest guidanceScale(BigDecimal guidanceScale) {
  ...
  **/
  ...
  public DreamboothText2imageRequest height(String height) {
  ...
  **/
  ...
  public DreamboothText2imageRequest key(String key) {
  ...
  **/
  ...
  public DreamboothText2imageRequest modelId(String modelId) {
  ...
  **/
  ...
  public DreamboothText2imageRequest negativePrompt(String negativePrompt) {
  ...
  **/
  ...
  public DreamboothText2imageRequest numInferenceSteps(String numInferenceSteps) {
  ...
  **/
  ...
  public DreamboothText2imageRequest prompt(String prompt) {
  ...
  **/
  ...
  public DreamboothText2imageRequest samples(String samples) {
  ...
  **/
  ...
  public DreamboothText2imageRequest seed(Object seed) {
  ...
  **/
  ...
  public DreamboothText2imageRequest trackId(Object trackId) {
  ...
  **/
  ...
  public DreamboothText2imageRequest webhook(Object webhook) {
  ...
  **/
  ...
  public DreamboothText2imageRequest width(String width) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DreamboothText2imageRequest dreamboothText2imageRequest = (DreamboothText2imageRequest) o;
    return Objects.equals(this.guidanceScale, dreamboothText2imageRequest.guidanceScale) &&
        Objects.equals(this.height, dreamboothText2imageRequest.height) &&
        Objects.equals(this.key, dreamboothText2imageRequest.key) &&
        Objects.equals(this.modelId, dreamboothText2imageRequest.modelId) &&
        Objects.equals(this.negativePrompt, dreamboothText2imageRequest.negativePrompt) &&
        Objects.equals(this.numInferenceSteps, dreamboothText2imageRequest.numInferenceSteps) &&
        Objects.equals(this.prompt, dreamboothText2imageRequest.prompt) &&
        Objects.equals(this.samples, dreamboothText2imageRequest.samples) &&
        equalsNullable(this.seed, dreamboothText2imageRequest.seed) &&
        equalsNullable(this.trackId, dreamboothText2imageRequest.trackId) &&
        equalsNullable(this.webhook, dreamboothText2imageRequest.webhook) &&
        Objects.equals(this.width, dreamboothText2imageRequest.width);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guidanceScale, height, key, modelId, negativePrompt, numInferenceSteps, prompt, samples, hashCodeNullable(seed), hashCodeNullable(trackId), hashCodeNullable(webhook), width);
  }
  ...
  public String toString() {
    ...
    sb.append("class DreamboothText2imageRequest {\n");
